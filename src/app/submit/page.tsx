...
export default function SubmitComplaint() {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
    ...
    if (name === 'evidence' && files && files[0]) {
                  ...
                  <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    {uploading ? (
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm text-blue-700">Uploading {form.evidence.name}...</span>
                      </div>
                    ) : uploadedFile ? (
                      <div className="space-y-3">
                        ...
                        <div className="text-sm text-gray-700">📁 {uploadedFile.filename}</div>
                        ...
                        {uploadedFile.type === 'application/pdf' && (
                          <div className="mt-3 p-3 bg-red-50 border border-red-200 rounded-lg">
                            <div className="flex items-center space-x-2">
                              ...
                              <span className="text-sm font-medium text-red-800">PDF Document</span>
                            </div>
                          </div>
                        )}
                      </div>
